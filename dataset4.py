...
query = """
SELECT
    pl_name, pl_letter, pl_rade, pl_bmasse, pl_orbper, pl_orbsmax, pl_orbeccen, pl_orbincl,
    hostname, st_teff, st_rad, st_mass, sy_kmag, st_lum, pl_insol, pl_eqt
FROM ps
"""
...
# Save cleaned data
data.to_csv("gaia_exoplanets_cleaned.csv", index=False)
print("Dataset successfully downloaded and saved as gaia_exoplanets_cleaned.csv")
print(data.head())
